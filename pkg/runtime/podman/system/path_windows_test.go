...
func TestHostPathToMachinePath(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:  "short path with drive letter only",
			input: "C:",
			want:  "C:",
		},
	}
...
func TestMachinePathToHostPath(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:  "POSIX mnt path",
			input: "/mnt/c/Users/user/project",
			want:  `C:\Users\user\project`,
		},
		{
			name:  "non-mnt absolute path",
